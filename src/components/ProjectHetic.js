                ...
                {project.tasks.map((task) => (
                  <div key={task.id} className="task-container">
                    ...
                    >
                      ...
                      <ul className="points-container">
                        {task.pointsWork1?.map((point, idx) => (
                          <li key={idx} className="item-point item-work">
                            {point}
                          </li>
                        ))}
                      </ul>
                      <ul className="points-container">
                        {task.pointsWork2?.map((point, idx) => (
                          <li key={idx} className="item-point item-work">
                            {point}
                          </li>
                        ))}
                      ...
                      <ul className="points-container">
                        {task.pointsWork3?.map((point, idx) => (
                          <li key={idx} className="item-point item-work">
                            {point}
                          </li>
                        ))}
                      ...
                      <ul className="points-container">
                        {task.pointsWork4?.map((point, idx) => (
                          <li key={idx} className="item-point item-work">
                            {point}
                          </li>
                        ))}
                      ...
                      <ul className="points-container">
                        {task.pointsWork5?.map((point, idx) => (
                          <li key={idx} className="item-point item-work">
                            {point}
                          </li>
                        ))}
                      ...
                      <ul className="points-container">
                        {task.pointsWork6?.map((point, idx) => (
                          <li key={idx} className="item-point item-work">
                            {point}
                          </li>
                        ))}
